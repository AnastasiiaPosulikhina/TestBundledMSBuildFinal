namespace OrleansApplication1.Server;
...
using OrleansApplication1.Grains;
using OrleansApplication1.Server.Options;
        ...
        siloBuilder
            ...
            .UseAzureStorageClustering(
                options => options.ConfigureTableServiceClient(
                    GetStorageOptions(context.Configuration).ConnectionString))
            .ConfigureEndpoints(
